...
public class Tela03 extends AppCompatActivity implements View.OnClickListener, Runnable {
    private TextView textoDoNome, contado_tela;
    private int quant_jogada;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contado_tela = findViewById(R.id.textView8);
        ...
        quant_jogada = 1;
        contado_tela.setText(Integer.toString(quant_jogada));
    ...
    public void onClick(View view) {
        ...
        if(view == fim){
            ...
            caixa.putInt("cont", quant_jogada);
            i.putExtras(caixa);
            startActivity(i);
